...
import { FaAndroid } from "react-icons/fa"; // Import Android icon
    ...
    <div className="bg-black py-16">
      <div className="relative flex items-center justify-between bg-cover bg-center px-10 py-20 max-w-7xl mx-auto rounded-lg">
        ...
        <div className="max-w-xl text-white">
          ...
          {/* Transparent Button */}
          <button className="border border-white text-white flex  items-center px-6 py-3 rounded-lg hover:bg-white hover:text-black transition duration-300">
